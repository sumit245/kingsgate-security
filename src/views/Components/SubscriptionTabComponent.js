...
export default class SubscriptionTabComponent extends Component {
  constructor(props) {
    super(props);
  ...
  addSubscription = () => {
    let subscol = document.getElementById("subs");
    let child = document.getElementById("subscriptionfield");
    console.log(newSubscription);
    subscol.innerHTML = child.outerHTML;
  ...
  submitForm = () => {
    ...
    newSubscription = {
      ...
      subscriptions: {
        ...
        subscription_amount: this.state.subscriptionAdvance,
        subscription_start_date: this.state.subscriptionStartDate,
        subscription_close_date: this.state.subscriptionCloseDate,
      },
    };
  ...
  componentDidMount() {
    axios
      .get("http://localhost:4000/kingsgate/"+this.props.userdata._id)
      .then((res) => {
    ...
    return (
      <div className="row">
        <div
          ...
          id="subs"
        >
          {this.props.userdata.subscriptions.map((data, key) => {
            return (
              <a
                href="/"
        ...
        >
          ...
          <label className="col-md-6 col-form-label">
            ...
            <input
              className="col-sm-12 form-control"
              value={this.state.subscriptionAdvance}
