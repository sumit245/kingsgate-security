...
import EditChallanAndAccept from "./EditChallanAndAccept";

window.JSZip = jzip;

export default class ChallanHistoryTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      stockData: [],
    ...
    return (
      <>
        <div className="container mx-auto my-4">
          ...
          <div id="editChallanModal" className="modal modal-fade" role='dialog' style={{width:1100,left:-50}} >
            <div className="modal-content">
              <EditChallanAndAccept />
